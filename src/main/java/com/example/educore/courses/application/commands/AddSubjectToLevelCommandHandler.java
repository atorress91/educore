...
public class AddSubjectToLevelCommandHandler
        implements CommandHandler<AddSubjectToLevelCommand, AcademicYearResponse> {

    private final AcademicYearRepository academicYearRepository;

    @Override
    public AcademicYearResponse handle(AddSubjectToLevelCommand command) {
        ...
        activeYear.addSubject(command.level(), command.subject().trim());
